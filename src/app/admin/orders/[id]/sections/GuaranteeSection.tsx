  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          KTP / selfie KTP / kartu pelajar sebagai pelengkap data order ini
          (opsional). Klik ✕ untuk menghapus bila salah upload.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="rounded-xl border bg-muted/30 p-4">
          <p className="mb-3 text-sm font-semibold">Upload jaminan (opsional)</p>
          <GuaranteeUpload
            orderId={order.id}
